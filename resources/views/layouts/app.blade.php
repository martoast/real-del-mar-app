...
>
        ...
        <div class="mx-auto max-w-7xl px-6 py-16 lg:px-10">
            ...
            <div class="mt-14 border-t border-sand-50/10 pt-8 text-xs leading-relaxed text-sand-200/50">
                <p>
                    ...
                    <span class="text-sand-200/30">· v1.0.3</span>
                </p>
                <p class="mt-2">
                    <x-t>
    ...
    <div class="fixed bottom-6 right-6 z-40 flex flex-col items-center gap-3">
        ...
        <a href="https://maps.app.goo.gl/VXKG3A8x1Q2A7C827" target="_blank" rel="noopener"
            ...
            class="flex h-14 w-14 items-center justify-center rounded-full bg-ocean-600 shadow-lg shadow-ink/20 transition-transform duration-300 hover:scale-110">
            <svg viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.7" class="h-7 w-7"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z"/></svg>
        </a>
        ...
        <a href="tel:+526641158106" onclick="if(window.fbq)fbq('track','Contact',{method:'call'})"
            ...
            class="flex h-14 w-14 items-center justify-center rounded-full bg-ocean-950 shadow-lg shadow-ink/20 transition-transform duration-300 hover:scale-110">
            <svg viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.7" class="h-7 w-7"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z"/></svg>
        </a>
